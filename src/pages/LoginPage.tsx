    ...
    return (
        <div className="min-h-screen flex font-sans">
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-12 bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-orange-400 flex items-center justify-center text-white font-bold text-sm">
                                R
                            </div>
                            <div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-16 bg-slate-50">
                <div
                    className={`w-full max-w-md transition-all duration-500 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                        }`}
                >
                    {/* Mobile logo */}
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-5">
                        ...
                        {mode === 'signup' && (
                            <div className="animate-task-in">
                                ...
                                <input
                                    ...
                                    placeholder="Tarun Mamillapalli"
                                    className={`w-full px-4 py-3 rounded-xl border-2 bg-white text-slate-900 placeholder-slate-400 text-sm font-medium outline-none transition-all duration-200 focus:scale-[1.01] focus:shadow-lg focus:shadow-primary/10 ${errors.name
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 rounded-xl border-2 bg-white text-slate-900 placeholder-slate-400 text-sm font-medium outline-none transition-all duration-200 focus:scale-[1.01] focus:shadow-lg focus:shadow-primary/10 ${errors.email
                                    ? 'border-red-400 focus:border-red-500'
                                    : 'border-slate-200 focus:border-primary focus:ring-4 focus:ring-primary/10'
                                    }`}
                            />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 py-3 pr-12 rounded-xl border-2 bg-white text-slate-900 placeholder-slate-400 text-sm font-medium outline-none transition-all duration-200 focus:scale-[1.01] focus:shadow-lg focus:shadow-primary/10 ${errors.password
                                        ? 'border-red-400 focus:border-red-500'
                                        : 'border-slate-200 focus:border-primary focus:ring-4 focus:ring-primary/10'
                                        }`}
                                />
                                <button
                                    ...
                                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-primary transition-colors p-1 rounded"
