...
export default function Hero() {
    return (
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
            ...
            <div className="absolute top-0 inset-x-0 h-full overflow-hidden -z-10 bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
                    ...
                    <div className="flex-1 max-w-2xl text-center lg:text-left z-10">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm mb-8 animate-fade-in-up">
                            ...
                            <span className="text-xs font-semibold text-slate-600 dark:text-slate-300">Loved by 10,000+ teams</span>
                        </div>

                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-[1.1] mb-6 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                        ...
                        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed max-w-lg mx-auto lg:mx-0 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                            ...
                            <Link
                                to="/login"
                                className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-semibold rounded-full border border-slate-200 dark:border-slate-600 shadow-sm transition-all hover:shadow-md active:scale-95"
                            >
                                Sign In
                            </Link>
                        </div>

                        <p className="mt-5 text-sm text-slate-500 dark:text-slate-500 font-medium animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                    ...
                    <div className="flex-1 w-full flex justify-center lg:justify-end lg:pl-10 relative z-10 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
                        <div className="relative w-full max-w-[600px]">
                            <DashboardMock />
                            {/* Floating badge */}
                            <div className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 p-4 rounded-xl shadow-xl flex items-center gap-4 animate-bounce" style={{ animationDuration: '3s' }}>
                                ...
                                <div>
                                    <p className="text-xs text-slate-500 dark:text-slate-400 font-semibold">Task Finished</p>
                                    <p className="text-sm font-bold text-slate-800 dark:text-slate-100">New landing page</p>
                                </div>
                            </div>
                        </div>
                    </div>
